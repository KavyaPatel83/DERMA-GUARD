...
class DermaGuardPredictor:
    ...
    def _get_model(self, model_code, meta_input_dim=None):
        ...
        if model_code == 'A':
            m = ModelA(embed_dim=256, num_classes=6, pretrained=False)
        elif model_code == 'B':
            m = ModelB(meta_input_dim=meta_input_dim, embed_dim=256, num_classes=6)
        elif model_code == 'C':
            m = ModelC(embed_dim=256, num_classes=6, pretrained=False)
        elif model_code == 'D':
            m = ModelD(meta_input_dim=meta_input_dim, embed_dim=256, num_classes=6, pretrained=False)
        elif model_code == 'E':
            m = ModelE(embed_dim=256, num_classes=6, pretrained=False)
        elif model_code == 'F':
            m = ModelF(meta_input_dim=meta_input_dim, embed_dim=256, num_classes=6, pretrained=False)
        elif model_code == 'G':
            m = ModelG(meta_input_dim=meta_input_dim, embed_dim=256, num_classes=6, pretrained=False)
