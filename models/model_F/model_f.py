...
class ModelF(nn.Module):
    ...
    """
    def __init__(self, meta_input_dim=109, embed_dim=256, num_classes=6, bert_name='emilyalsentzer/Bio_ClinicalBERT', pretrained=True):
        super().__init__()
        self.embed_dim = embed_dim
        self.meta_encoder = MetadataEncoder(input_dim=meta_input_dim, embed_dim=embed_dim)
        self.text_encoder = LanguageEncoder(model_name=bert_name, embed_dim=embed_dim, pretrained=pretrained)
